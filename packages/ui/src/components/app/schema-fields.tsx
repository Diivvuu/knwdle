...
const FRIENDLY_DESCRIPTIONS: Record<string, string> = {
  tags: 'Add keywords that help search and filter this audience.',
  startDate: 'Choose when this audience becomes active.',
  endDate: 'Optional end date for the audience lifecycle.',
  meetingDay: 'Pick the usual day this audience meets.',
  meetingTime: 'Specify the meeting start time (HH:mm).',
  scheduleDays: 'List the days the audience is active or classes run.',
  daysOfWeek: 'Pick the regular working days.',
  focus: 'Give a short theme or focus area.',
  customTypeLabel: 'Display name for the “Other” audience type.',
  officeLocation: 'Where team members can find this audience.',
  contactPhone: 'Include country code if required.',
  contactEmail: 'Who should receive communications for this audience?',
