...
// // dashboard -  get org basic info by id
// r.get(
//   '/orgs/:id',
//   requireAuth,
...
// // dashboard - get org summary by id
// r.get(
//   '/orgs/:id/summary',
//   requireAuth,
//   requirePermission('org.read'),
...
// // members - members paginated list
// r.get(
//   '/orgs/:id/members',
//   requireAuth,
...
// // members - for particular unit members
// r.get(
...
// // members - member mutations kept minimal (update base role)
// r.patch(
...
// // members - member mutation (update unit)
// r.patch(
...
// // members - assign/remove custom role
// r.patch(
...
// // members - remove member from org
// r.delete(
//   '/orgs/:id/members/:userId',
//   requireAuth,
//   requirePermission('people.manage'),
...
// // unit - delete org unit id - use ?force=true for force delete
// r.delete(
//   '/orgs/:id/units/:unitId',
//   requireAuth,
//   requirePermission('org.update'),
